...
describe('WidgetFocusProvider', () => {
  ...
  it('should update url on widget focus', async () => {
    ...
    expect(mockNavigate).toBeCalledWith('?focusedId=widget-id&focusing=true', { replace: true });
  });
  ...
  it('should update url on widget edit', async () => {
    ...
    expect(mockNavigate).toBeCalledWith('?focusedId=widget-id&editing=true', { replace: true });
  });
  ...
  it('should not remove focus query param on widget edit', async () => {
    ...
    expect(mockNavigate).toBeCalledWith('?focusedId=widget-id&focusing=true&editing=true', { replace: true });
